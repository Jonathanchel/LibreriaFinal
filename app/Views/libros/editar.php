    ...
    <div class="card-body">
        ...
        <form method="post" action="<?=site_url('/actualizar')?>" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <br><img class="img-thumbnail" src="<?=base_url()?>./public/uploads/<?=$libro['imagen'];?>" width="100"
                    alt="">
            ...
            <div class="form-group">
                ...
                <input id="descripcionc" value="<?=$libro['descripcionc']?>" class="form-control" type="text"
                    name="descripcionc">
            </div>
            <div class="form-group">
                <label for="descripcion">Descripción</label>
                <input id="descripcion" value="<?=$libro['descripcion']?>" class="form-control" type="text"
                    name="descripcion">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input id="editorial" value="<?=$libro['editorial']?>" class="form-control" type="text"
                    name="editorial">
            </div>
            <div class="form-group">
