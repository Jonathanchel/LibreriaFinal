...
<body style="font-family: Arial, Helvetica, sans-serif; background-color: rgba(255, 255, 255, 0.7);">
    <div class="container">
        <div class="row">
            <div class="col-3">
                <img class="img-thumbnail" src="<?=base_url()?>./public/uploads/<?=$libro['imagen'];?>" width="300"
                    alt="">
            </div>
            <div class="col-6">
    ...
    <a href="<?=base_url('libreria')?>" class="btn btn-success mb-3" type="button">Regresar</a>
